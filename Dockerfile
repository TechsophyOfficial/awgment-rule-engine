...
ENTRYPOINT ["java", "-Dotel.exporter=jaeger", "-Dotel.exporter.jaeger.endpoint=http://jaeger:14250", "-Dotel.exporter.jaeger.service.name=rule-engine", "-Dapplication.name=tp-rule-engine", "-javaagent:/home/spring/app/bin/opentelemetry-javaagent-all.jar", "-jar","/home/spring/app/bin/tp-rule-engine-1.2.0.jar"]
